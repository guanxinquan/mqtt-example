...
public class Test {
    ...
    public static void main(String args[]) throws InterruptedException {
        Integer clientBegin = Integer.valueOf(System.getProperty("client", "0"));
        Integer size = Integer.valueOf(System.getProperty("size", "10000"));
        sleepTime = Long.valueOf(System.getProperty("sleep","50000"));
        messageCnt = Integer.valueOf(System.getProperty("cnt", "100"));
        Long dur = Long.valueOf(System.getProperty("dur","10"));
